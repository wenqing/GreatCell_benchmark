...
fracture_angle_to_bag1_sx = -78.75; //-112.5;
...
Point(70) = {r2*cth-r2/30*sth, r2*sth +r2/30*cth, 0, lc2};
Point(700) = {r2*cth+r2/30*sth, r2*sth -r2/30*cth, 0, lc2};
Point(71) = {-r2*sth, r2*cth, 0, lc2};
Point(720) = {-r2*cth+r2/30*sth, -r2*sth -r2/30*cth, 0, lc2};
Point(72) = {-r2*cth-r2/30*sth, -r2*sth +r2/30*cth, 0, lc2};
Point(73) = {r2*sth, -r2*cth, 0, lc2};
...
Curve Loop(6) = {80, 77, 78, 79};
Curve Loop(7) = {70, -72, -79};

Transfinite Line{77,79} = 90 Using Progression 1.0;
Transfinite Line{78,80} = 4 Using Progression 1.0;

Plane Surface(1) = {1};
Plane Surface(6) = {6};
Plane Surface(7) = {7};
Plane Surface(3) = {5,1,6,7};
Plane Surface(4) = {3,5};
Plane Surface(5) = {4,3};
...
out1[]=Extrude {0, 0, 0.2} { Surface{1};Layers{10};};
out2[]=Extrude {0, 0, 0.2} { Surface{7};Layers{10};};
out3[]=Extrude {0, 0, 0.2} { Surface{3};Layers{10};};
out4[]=Extrude {0, 0, 0.2} { Surface{4};Layers{10};};
out5[]=Extrude {0, 0, 0.2} { Surface{5};Layers{10};};
out6[]=Extrude {0, 0, 0.2} { Surface{6};Layers{10};};

Physical Volume(1) = {out1[],out2[],out3[],out4[],out5[],out6[]};
