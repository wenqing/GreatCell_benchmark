...
def create_xml_file(file_name):
    ...
    replace_elements = [
        ...
        ("/*/time_loop/output/prefix/text()", "GreatCell_3D_embedded_fracture_Resin"),
        ("/*/parameters/parameter[name='E1']/value/text()", "3.84e9"),
        ("/*/parameters/parameter[name='nu1']/value/text()", "0.4"),
        ("/*/parameters/parameter[name='k']/value/text()", "1.0e-24"),
        ("/*/parameters/parameter[name='Kn']/value/text()", "300.0e+9"),
        ("/*/parameters/parameter[name='Ks']/value/text()", "250.0e+9"),
    ...
    ET.indent(tree, '    ')
    tree.write(file_name + '_embedded_frature_resin_high_kn.xml', encoding="ISO-8859-1",
